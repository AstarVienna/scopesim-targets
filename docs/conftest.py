...
Plain markdown files (no jupytext/mystnb front matter) are ignored, so this
can live next to regular docs pages.

Usage::

    pytest docs --notebooks          # run all notebooks
    pytest docs/quickstart.md --notebooks
"""
